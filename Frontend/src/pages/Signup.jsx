        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 bg-white border ${
                errors.name ? 'border-red-400 focus:ring-red-400/30 focus:border-red-400' : 'border-slate-200 focus:ring-slate-300 focus:border-slate-400'
          ...
          <div>
            ...
            <input
              ...
              type="password"
              className={`w-full px-4 py-2.5 bg-white border ${
                errors.confirmPassword ? 'border-red-400 focus:ring-red-400/30 focus:border-red-400' : 'border-slate-200 focus:ring-slate-300 focus:border-slate-400'
              } rounded-xl text-slate-800 focus:outline-none focus:ring-2 transition-all duration-200 shadow-sm`}
              placeholder="••••••••"
          ...
          <div className="space-y-3 pt-1">
            ...
            <button
              type="button"
              className="w-full py-3 px-4 flex justify-center items-center text-sm font-semibold rounded-xl text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition-all duration-200 active:scale-[0.98]"
            >
